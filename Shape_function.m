function [R, dR_dx, J] = Shape_function(xi_t, eta_t, e, p, q, Bx,By,W, U, V, INC, IEN)
...
J_mat = dx_dxi*dxi_dtxi; %Jacobian matrix  of mapping from parent element 
                         %coordinates to physical coordinates 
J = det(J_mat);          %Jacobian determinant
end
